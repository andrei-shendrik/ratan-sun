...
from .models import FitsObservationFastAcquisition1To3GHz
...
def get_latest_observation(request):
    ...
    latest_obs = FitsObservationFastAcquisition1To3GHz.objects.exclude(json_path__isnull=True).first()
    ...
    azimuth_zero_obs = FitsObservationFastAcquisition1To3GHz.objects.filter(
