...
from ratanpy.ratan.fast_acquisition_1_3ghz.readers.fast_acquisition_1_3ghz_bin_reader import \
...
from ratanpy.ratan.sspc.sspc_fits_reader import SSPCFitsReader
